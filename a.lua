...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/wally-rblx/LinoriaLib/main//Library.lua"))() -- Could Also Save It In Your Workspace And Do loadfile("Library.lua")()
