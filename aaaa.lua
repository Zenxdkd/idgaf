...
task.spawn(function () while task.wait() do if getgenv().KLOX.Resolver.AutoResolve == true then checkVelocity(prey or prey2, getgenv().KLOX.Resolver.Positive, getgenv().KLOX.Resolver.Negative) end end end)
