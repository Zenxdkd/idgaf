...
local Window = Library:New({Name = "| KLOX CAMLOCK | 9XN ", Size = Vector2.new(489, 570), Accent = Color3.fromRGB(161, 165, 162)})
--
...
while task.wait() do
    if Prey then
        if getgenv().KLOX.Silent.Enabled and getgenv().DNS.Silent.ClosestPart == true then
